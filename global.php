<?php
  ...
  { 
    ...
    foreach($reserve as $row)
    {
      ...
      echo "<td><input class='btn btn-success' type='button' data-value=".$row['id']." onclick='acceptRes($(this).data().value)' name='accept' value='Accept'><br><input class='btn btn-danger' type='button' data-value=".$row['id']." onclick='deleteRes($(this).data().value)' name='delete' value='Delete'></td>";
      echo "</tr>";
    } 
  }
