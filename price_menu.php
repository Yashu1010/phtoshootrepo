...
<body> 
	 	<div class="main-div"> 
	 	 	<h1 align="center" style="font-size: 35px; margin-top:80px; font-family:serif; color:white;">Album Details </h1> 
...
<div class="main-div"> 
	 	 	<h1 align="center" style="font-size: 35px; margin-top:30px; font-family:serif; color:white;">Videography Details </h1> 
...
?> 
	 	...
	 	<button style="background-color: #1B6576; 
                    ...
                    top: 10%;width: 120px; height: 50px; right: 8%;">Add Album</button> 
	 	 	 	 	</a> 
	 	<a href="index.php">  -->
	 	<!-- <button style="background-color: #1B6576; 
 	 	 	 	 	color: #ffffff; font-size: 20px; position: fixed;
                    bottom: 6%; width: 80px; height: 40px; right: 8%;">BACK</button> 
	 	 	 	 	</a>  -->
